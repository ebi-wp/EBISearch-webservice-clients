...
COMMAND="java  -classpath 'java/lib/*':'java/EBeye_JAXRS.jar' EBeyeClient --getNumberOfResults hgnc human --endpoint http://www.ebi.ac.uk/ebisearch/ws/rest -debugLevel 1 | grep -q '15' ; echo $?"
echo $COMMAND
$COMMAND